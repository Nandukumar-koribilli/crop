...
const CropPredictorPage: React.FC = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div className="text-center">
      ...
      <div className="flex justify-center space-x-6 text-sm text-white/50 mb-4">
      ...
      <div className="flex justify-center space-x-4 mb-4">
        <a href="https://github.com/Nandukumar-koribilli" target="_blank" rel="noopener noreferrer" 
        ...
        <a href="https://www.linkedin.com/in/nandukumar-koribilli-062ba42a2/" target="_blank" rel="noopener noreferrer" 
           className="text-white/70 hover:text-white transition-colors">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
